...
public class QRCodeUtils {
    ...
    public static void main(String[] args) throws Exception {
        String text = "222222";
        //不含Logo  
        //QrCodeUtils2.encode(text, null, "dizhi", true);
        //含Logo，不指定二维码图片名  
        //QrCodeUtils2.encode(text, "logo", "dizhi", true);
        //含Logo，指定二维码图片名  
        String resource = QRCodeUtils.class.getResource("/static/img/logo.jpg").getPath();
        int rand = new Random().nextInt(99999999);
        String encode = QRCodeUtils.encode(text, resource, "E:/", "qrcode", true);
